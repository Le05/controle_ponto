                ...
                child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                                            ...
                                            if (geo == true) {
                                              try {
                                                ...
                                                if (e.code ==
                                                  ...
                                                  await geolocator
                                                      .getCurrentPosition();
                                                } else if(e.code == "ERROR_GEOCODING_INVALID_COORDINATES") {
                                                  await mensagemErroGeral(
                                                      context, "Ocorreu um erro ao obter a localização!! Por favor, verifique as permissões e se o GPS está ativo");
                                                }
                                              }
                                            } else {
                                              pr.hide();
                        ...
                        SizedBox(
                          height: orientacao == "Orientation.portrait" ? 20 : 5,
                        ),
                        ButtonTheme(
                            ...
                            child: RaisedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  marcaPonto.sequenciaPontos = pontoSequencia[1]
